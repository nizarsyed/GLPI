...
Html::header(PluginArchidataDataelement::getTypeName(2), '', "assets","pluginarchidatamenu");
$swcomponent = new PluginArchidataDataelement();

if ($swcomponent->canView() || Session::haveRight("config", UPDATE)) {
   Search::show('PluginArchidataDataelement');
} else {
