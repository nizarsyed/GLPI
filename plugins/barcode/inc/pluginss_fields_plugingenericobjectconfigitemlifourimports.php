...
class pluginss_fields_plugingenericobjectconfigitemlifourimports extends CommonDBTM {
    
    // Define the table name
    static $table = 'glpi_pluginss_fields_plugingenericobjectconfigitemlifourimports';
